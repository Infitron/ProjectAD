...
{
    public partial class bluechub_ProdContext : DbContext
    {
        public bluechub_ProdContext()
        {
        }

        public bluechub_ProdContext(DbContextOptions<bluechub_ProdContext> options)
            : base(options)
        {
        }
